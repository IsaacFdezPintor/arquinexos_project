...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ==========================================
        // PROYECTO 1: Vivienda Unifamiliar (En curso)
        // ==========================================
        $p1 = Project::create([
        ...
        // ==========================================
        // PROYECTO 2: Reforma Restaurante (En curso)
        // ==========================================
        $p2 = Project::create([
        ...
        // ==========================================
        // PROYECTO 3: Urbanización (Planificación)
        // ==========================================
        $p3 = Project::create([
            'name' => 'Urbanización El Mirador',
            'type' => 'urbanismo',
            'client_name' => 'Ayuntamiento de Pozuelo',
            'status' => 'pending',
            'budget' => 450000,
        ...
        // ==========================================
        // PROYECTO 4: Auditorio Municipal (Finalizado)
        // ==========================================
        $p4 = Project::create([
            'name' => 'Auditorio Municipal San Juan',
            'type' => 'edificacion',
            'client_name' => 'Fundación Cultural',
            'status' => 'completed',
            'budget' => 1200000,
        ...
        // ==========================================
        // PROYECTO 5: Nave Industrial (Retrasado/Pausado)
        // ==========================================
        $p5 = Project::create([
            'name' => 'Nave Logística Amazon',
            'type' => 'industrial',
            'client_name' => 'Inversiones Logísticas S.A.',
            'status' => 'pending',
            'budget' => 890000,
